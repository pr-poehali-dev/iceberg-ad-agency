...
export default function Index() {
  ...
  return (
    <div className="w-full" style={{ background: "#111a1f", color: "#E8EDF3", fontFamily: "Inter, sans-serif" }}>

      {/* ── NAV ── */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
        style={{ background: scrolled ? "rgba(17,26,31,0.95)" : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", borderBottom: scrolled ? "1px solid rgba(90,127,181,0.12)" : "none" }}
      >
        <div className="max-w-7xl mx-auto px-5 md:px-10 flex items-center justify-between h-16">
          <a href="#" className="flex items-center gap-2.5">
            <img src={LOGO_URL} alt="KeyCard" className="h-9 w-9 object-cover rounded-lg" style={{ border: "1px solid rgba(90,127,181,0.3)" }} />
            <span className="font-black text-sm tracking-widest uppercase" style={{ color: "#E8EDF3" }}>
              Key<span style={{ color: "#5A7FB5" }}>Card</span>
            </span>
          </a>
          ...
          <a href="#contact" className="hidden md:flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all hover:opacity-90"
            style={{ background: "linear-gradient(135deg,#5A7FB5,#8D9E47)", color: "#fff" }}>
        ...
        {menuOpen && (
          <div className="md:hidden px-5 pb-5 flex flex-col gap-4" style={{ background: "rgba(17,26,31,0.98)", borderTop: "1px solid rgba(90,127,181,0.1)" }}>
            {NAV.map((n) => (
            ...
            <a href="#contact" className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-bold mt-2"
              style={{ background: "linear-gradient(135deg,#5A7FB5,#8D9E47)", color: "#fff" }} onClick={() => setMenuOpen(false)}>
              Получить аудит <Icon name="ArrowUpRight" size={14} />
            </a>
          </div>
        )}
      ...
      <section ref={heroRef} id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden"
        style={{ background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(90,127,181,0.12) 0%, transparent 70%)" }}>
        {/* Grid overlay */}
        <div className="absolute inset-0 pointer-events-none" style={{
          backgroundImage: "linear-gradient(rgba(90,127,181,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(90,127,181,0.04) 1px, transparent 1px)",
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10 pt-28 pb-20 w-full">
          <div className="max-w-4xl">
            <div className="hero-line inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 text-xs font-semibold tracking-widest uppercase"
              style={{ background: "rgba(90,127,181,0.1)", border: "1px solid rgba(90,127,181,0.2)", color: "#6B9BAD" }}>
            ...
            <h1 className="hero-line font-black leading-[0.95] mb-6" style={{ fontSize: "clamp(3rem,8vw,7rem)", letterSpacing: "-0.02em" }}>
              Будь первым<br />
              <span style={{ background: "linear-gradient(90deg,#5A7FB5,#8D9E47)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                на картах
              </span>
            </h1>
            ...
            <div className="hero-line flex flex-col sm:flex-row gap-4 mb-20">
              ...
              <a href="#vacancy" className="flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-bold text-base transition-all hover:opacity-80"
                style={{ border: "1px solid rgba(90,127,181,0.3)", color: "#E8EDF3" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
              {STATS.map((s, i) => (
                <div key={i} className="hero-stat rounded-2xl px-5 py-4"
                  style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(90,127,181,0.12)" }}>
                  <p className="font-black text-3xl mb-1" style={{ background: "linear-gradient(90deg,#5A7FB5,#8D9E47)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>{s.value}</p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
          ...
          <Icon name="ChevronDown" size={16} style={{ color: "rgba(90,127,181,0.5)" }} />
        </div>
      </section>
      ...
      <div ref={storyRef} id="about" style={{ height: `${STORY_STEPS.length * 100 + 100}vh` }}>
        <div ref={storyPinRef} className="h-screen w-full flex items-center justify-center overflow-hidden relative"
          ...
          <div className="absolute top-8 right-8 text-right z-10">
            <p className="font-black text-6xl leading-none" style={{ color: "rgba(90,127,181,0.08)", fontVariantNumeric: "tabular-nums" }}>
              0{activeStep + 1}
            </p>
          ...
          <div className="max-w-5xl mx-auto px-10 md:px-20 w-full grid md:grid-cols-2 gap-16 items-center">
            <div key={activeStep} style={{ animation: "storyIn 0.5s ease forwards" }}>
              ...
              <a href="#contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all hover:opacity-90"
                style={{ background: `linear-gradient(135deg,${step.accent},#8D9E47)`, color: "#fff" }}>
      ...
      <section id="approach" className="py-28 relative overflow-hidden" style={{ background: "#111a1f" }}>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10 relative">
          <div className="mb-16">
            <p className="text-xs font-bold tracking-[0.3em] uppercase mb-4" style={{ color: "#8D9E47" }}>Наш подход</p>
            <h2 className="font-black leading-tight" style={{ fontSize: "clamp(2rem,5vw,3.5rem)", letterSpacing: "-0.02em" }}>
              ...
              <span style={{ background: "linear-gradient(90deg,#8D9E47,#5A7FB5)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {APPROACH.map((a, i) => (
              <div key={i} className="group relative rounded-3xl p-8 transition-all duration-500 hover:-translate-y-2"
                style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(141,158,71,0.12)" }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(141,158,71,0.4)"; e.currentTarget.style.background = "rgba(141,158,71,0.06)"; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(141,158,71,0.12)"; e.currentTarget.style.background = "rgba(255,255,255,0.02)"; }}>
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6"
                  style={{ background: "rgba(141,158,71,0.12)", border: "1px solid rgba(141,158,71,0.2)" }}>
                  <Icon name={a.icon} size={22} style={{ color: "#8D9E47" }} />
                </div>
                <p className="text-4xl font-black mb-3" style={{ color: "rgba(141,158,71,0.12)", fontVariantNumeric: "tabular-nums" }}>0{i + 1}</p>
      ...
      <div ref={servicesRef} id="services" style={{ height: `${SERVICES.length * 80 + 100}vh` }}>
        <div ref={servicesPinRef} className="h-screen w-full flex items-center overflow-hidden"
          ...
          <div className="max-w-7xl mx-auto px-5 md:px-10 w-full grid md:grid-cols-2 gap-16 items-center">
            ...
            {/* Left: list */}
            <div>
              <p className="text-xs font-bold tracking-[0.3em] uppercase mb-4" style={{ color: "#5A7FB5" }}>Инструменты</p>
              ...
              <div className="flex flex-col gap-3">
                {SERVICES.map((s, i) => (
                  <button key={i} className="flex items-center gap-4 px-5 py-4 rounded-2xl text-left transition-all duration-300 w-full"
                    style={{
                      background: i === activeService ? "rgba(90,127,181,0.1)" : "rgba(255,255,255,0.02)",
                      border: `1px solid ${i === activeService ? "rgba(90,127,181,0.4)" : "rgba(90,127,181,0.08)"}`,
                    }}
                    onClick={() => setActiveService(i)}>
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0"
                      style={{ background: i === activeService ? "rgba(90,127,181,0.2)" : "rgba(255,255,255,0.04)" }}>
                      <Icon name={s.icon} size={16} style={{ color: i === activeService ? "#6B9BAD" : "rgba(180,200,230,0.4)" }} />
                    </div>
                    <span className="font-semibold text-sm transition-colors"
                      style={{ color: i === activeService ? "#E8EDF3" : "rgba(180,200,230,0.5)" }}>
                      {s.title}
                    </span>
                    <span className="ml-auto text-xs font-mono" style={{ color: i === activeService ? "#5A7FB5" : "rgba(180,200,230,0.2)" }}>{s.num}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div key={activeService} style={{ animation: "storyIn 0.4s ease forwards" }}>
              <div className="rounded-3xl p-10 relative overflow-hidden"
                style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(90,127,181,0.2)", minHeight: 340 }}>
                <div className="absolute -top-16 -right-16 w-48 h-48 rounded-full opacity-20"
                  style={{ background: "radial-gradient(circle,#5A7FB5,transparent)" }} />
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6"
                    style={{ background: "rgba(90,127,181,0.12)", border: "1px solid rgba(90,127,181,0.25)" }}>
                    <Icon name={service.icon} size={28} style={{ color: "#6B9BAD" }} />
                  </div>
                  <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: "rgba(90,127,181,0.6)" }}>{service.num}</p>
      ...
      {/* ── PRICING ── */}
      <section id="pricing" className="py-28 relative" style={{ background: "#111a1f" }}>
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <div className="text-center mb-16">
            <p className="text-xs font-bold tracking-[0.3em] uppercase mb-4" style={{ color: "#5A7FB5" }}>Тарифы</p>
            <h2 className="font-black leading-tight" style={{ fontSize: "clamp(2rem,5vw,3.5rem)", letterSpacing: "-0.02em" }}>
          ...
          <div className="flex justify-center mb-10">
            <div className="flex rounded-2xl p-1" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(90,127,181,0.12)" }}>
              {PLANS.map((p, i) => (
                <button key={i} onClick={() => setActivePlan(i)}
                  className="px-6 py-3 rounded-xl text-sm font-bold transition-all duration-300"
                  style={{
                    background: i === activePlan ? "linear-gradient(135deg,#5A7FB5,#8D9E47)" : "transparent",
          ...
          <div key={activePlan} className="max-w-2xl mx-auto" style={{ animation: "storyIn 0.4s ease forwards" }}>
            <div className="rounded-3xl overflow-hidden" style={{ border: "1px solid rgba(90,127,181,0.25)", background: "rgba(255,255,255,0.02)" }}>
              <div className="px-8 py-6" style={{ background: "linear-gradient(135deg,rgba(90,127,181,0.12),rgba(141,158,71,0.08))", borderBottom: "1px solid rgba(90,127,181,0.15)" }}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs font-bold tracking-widest uppercase mb-1" style={{ color: "#6B9BAD" }}>{PLANS[activePlan].period}</p>
              ...
              <div className="px-8 py-6">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="rounded-2xl p-4 text-center" style={{ background: "rgba(90,127,181,0.06)", border: "1px solid rgba(90,127,181,0.15)" }}>
                    <p className="text-xs mb-1" style={{ color: "rgba(180,200,230,0.5)" }}>Без репутации</p>
                    <p className="font-black text-xl" style={{ color: "#6B9BAD" }}>{PLANS[activePlan].prices[0]}</p>
                  </div>
                  <div className="rounded-2xl p-4 text-center" style={{ background: "rgba(141,158,71,0.06)", border: "1px solid rgba(141,158,71,0.15)" }}>
                    <p className="text-xs mb-1" style={{ color: "rgba(180,200,230,0.5)" }}>С репутацией</p>
                    <p className="font-black text-xl" style={{ color: "#B5BC8A" }}>{PLANS[activePlan].prices[1]}</p>
                  </div>
                </div>
                  ...
                  {PLANS[activePlan].features.map((f, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm" style={{ color: "rgba(180,200,230,0.8)" }}>
                      <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0"
                        style={{ background: "rgba(90,127,181,0.15)", border: "1px solid rgba(90,127,181,0.3)" }}>
                        <Icon name="Check" size={11} style={{ color: "#6B9BAD" }} />
                      </div>
                      {f}
                    </li>
                  ))}
            ...
            <div className="grid grid-cols-3 gap-3 mt-4">
              {PLANS.map((p, i) => (
                <button key={i} onClick={() => setActivePlan(i)}
                  ...
                  style={{
                    background: i === activePlan ? "rgba(90,127,181,0.1)" : "rgba(255,255,255,0.02)",
                    border: `1px solid ${i === activePlan ? "rgba(90,127,181,0.4)" : "rgba(90,127,181,0.08)"}`,
                  }}>
                  <p className="font-bold text-xs mb-1" style={{ color: i === activePlan ? "#E8EDF3" : "rgba(180,200,230,0.4)" }}>{p.name}</p>
                  <p className="text-[10px]" style={{ color: i === activePlan ? "rgba(107,155,173,0.8)" : "rgba(180,200,230,0.25)" }}>{p.period}</p>
                </button>
              ))}
            </div>
          </div>
      ...
      {/* ── LEAD FORM (разбор) ── */}
      <section id="vacancy" className="py-28 relative overflow-hidden" style={{ background: "linear-gradient(180deg,#111a1f 0%,#121c20 100%)" }}>
        <div className="absolute inset-0 pointer-events-none" style={{
          background: "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(90,127,181,0.07) 0%, transparent 70%)"
        }} />
        <div className="max-w-2xl mx-auto px-5 md:px-10 relative">
          <div className="text-center mb-12">
            <p className="text-xs font-bold tracking-[0.3em] uppercase mb-4" style={{ color: "#5A7FB5" }}>Бесплатно</p>
          ...
          <div className="grid grid-cols-3 gap-3 mb-10">
            {[
              ...
              <div key={i} className="rounded-2xl p-4 text-center flex flex-col items-center gap-2"
                style={{ background: "rgba(90,127,181,0.05)", border: "1px solid rgba(90,127,181,0.15)" }}>
          ...
          <div className="rounded-3xl overflow-hidden" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(90,127,181,0.2)" }}>
            {leadSent ? (
                ...
                {[
                  ...
                  <div key={key}>
                    ...
                    <input type={type} value={leadForm[key as keyof typeof leadForm]}
                      ...
                      style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(90,127,181,0.2)", color: "#E8EDF3" }}
                      onFocus={e => e.currentTarget.style.borderColor = "rgba(90,127,181,0.6)"}
                      onBlur={e => e.currentTarget.style.borderColor = "rgba(90,127,181,0.2)"} />
                  </div>
                ))}
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="py-28 relative" style={{ background: "#111a1f" }}>
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <div className="text-center mb-16">
            <p className="text-xs font-bold tracking-[0.3em] uppercase mb-4" style={{ color: "#8D9E47" }}>Контакты</p>
            <h2 className="font-black leading-tight" style={{ fontSize: "clamp(2rem,5vw,3.5rem)", letterSpacing: "-0.02em" }}>
              Готовы обсудить<br />
              <span style={{ background: "linear-gradient(90deg,#8D9E47,#5A7FB5)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                ваш проект?
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="rounded-3xl p-8" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(141,158,71,0.15)" }}>
              ...
              <div className="space-y-4">
                <a href="tel:+79119944122" className="flex items-center gap-4 group">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center"
                    style={{ background: "rgba(90,127,181,0.1)", border: "1px solid rgba(90,127,181,0.2)" }}>
                    <Icon name="Phone" size={18} style={{ color: "#6B9BAD" }} />
                  </div>
                  <div>
                ...
                <a href="mailto:info@keycard-promotion.ru" className="flex items-center gap-4 group">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center"
                    style={{ background: "rgba(141,158,71,0.1)", border: "1px solid rgba(141,158,71,0.2)" }}>
                    <Icon name="Mail" size={18} style={{ color: "#B5BC8A" }} />
                  </div>
                  <div>
                ...
                <a href="https://t.me/yandex_promotion" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center"
                    style={{ background: "rgba(90,127,181,0.1)", border: "1px solid rgba(90,127,181,0.2)" }}>
                    <Icon name="Send" size={18} style={{ color: "#6B9BAD" }} />
                  </div>
                  <div>
            ...
            <div className="rounded-3xl p-8 flex flex-col justify-center items-center text-center"
              style={{ background: "linear-gradient(135deg,rgba(90,127,181,0.08),rgba(141,158,71,0.08))", border: "1px solid rgba(90,127,181,0.2)" }}>
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6"
                style={{ background: "rgba(90,127,181,0.15)", border: "1px solid rgba(90,127,181,0.3)" }}>
                <Icon name="Rocket" size={28} style={{ color: "#6B9BAD" }} />
              </div>
      ...
      {/* ── FOOTER ── */}
      <footer className="py-10" style={{ borderTop: "1px solid rgba(90,127,181,0.1)", background: "#0d1518" }}>
        <div className="max-w-7xl mx-auto px-5 md:px-10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <img src={LOGO_URL} alt="KeyCard" className="h-8 w-8 object-cover rounded-lg" style={{ border: "1px solid rgba(90,127,181,0.2)" }} />
            <span className="text-sm font-black tracking-widest uppercase" style={{ color: "#E8EDF3" }}>
              Key<span style={{ color: "#5A7FB5" }}>Card</span> Promotion
            </span>
          </div>
      ...
      {privacyOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.75)" }} onClick={() => setPrivacyOpen(false)}>
          <div className="rounded-3xl p-8 max-w-lg w-full max-h-[80vh] overflow-y-auto" style={{ background: "#162028", border: "1px solid rgba(90,127,181,0.2)" }} onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4 text-sm leading-relaxed" style={{ color: "rgba(180,200,230,0.7)" }}>
              ...
              <p>По вопросам: <a href="mailto:info@keycard-promotion.ru" style={{ color: "#6B9BAD" }}>info@keycard-promotion.ru</a></p>
            </div>
          </div>
        </div>
      )}
